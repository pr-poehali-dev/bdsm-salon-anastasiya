...
const services = [
  ...
  { 
    ...
    duration: '90 минут', 
    price: '22 000 ₽',
    description: 'Работа с напильниками и ножницами'
  },
  { 
    id: '3', 
    name: 'VIP сеанс', 
    duration: '120 минут', 
    price: '30 000 ₽',
    description: 'Полный набор инструментов: пассатижи, напильники, ножницы'
  },
  { 
    id: '4', 
    name: 'Маникюр всего тела', 
    duration: '45 минут', 
    price: '50 000 ₽',
    description: 'Комплексный уход с использованием профессиональной бензопилы'
  },
  { 
    id: '5', 
    name: 'Консультация', 
